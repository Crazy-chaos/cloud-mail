...
const premKey = {
	...
	'setting:set': ['/setting/set', '/setting/setBackground','/setting/deleteBackground','/setting/setBlacklist', '/setting/saveProfile'],
	'analysis:query': ['/analysis/echarts'],
	'reg-key:add': ['/regKey/add'],
	'reg-key:query': ['/regKey/list','/regKey/history'],
	'reg-key:delete': ['/regKey/delete','/regKey/clearNotUse'],
	'blog:manage': ['/blog/post', '/blog/admin', '/blog/upload'],
	'blog:manage_group': ['/blog/post', '/blog/admin', '/blog/upload'],
